...
function Chrono() {
    ...
    const [sessionTimeFixed, setSessionTimeFixed] = useState(180);
    ...
    useEffect(() => { // Gérer le cycle de vie d'un composant 
    ...
    }, [workingChrono]) // a chaque fois que je clique sur working chrono ça actualise 
        ...
        <div className={workingChrono ? 'container-chrono anim-glow' : 'container-chrono'}>
            ...
            (
                <span>
                    ...
                    ${sessionTime % 60 < 10 
                        ? `0${sessionTime % 60}` // afficher des secondes on rajoute un réseau si < 10 
                        : `${sessionTime%60}`}`
                    }
                </span>
            )
            ...
            (
                    ...
                    ${breakTime % 60 < 10 
                        ? `0${breakTime % 60}` // afficher des secondes on rajoute un réseau si < 10 
                        : `${breakTime%60}`}`
                    }
                    </span>
                    )
